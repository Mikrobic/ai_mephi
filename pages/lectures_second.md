---
layout: page
permalink: /lectures_second/
description: "Тест автоматизации лекций"
---

<div style="text-align: center;">

{% if site.data.lectures_second %}
  {% for section in site.data.lectures_second %}
...
{% else %}
  ...
  <p style="color: red;">❌ Данные НЕ найдены в site.data.lectures_second</p>
{% endif %}
